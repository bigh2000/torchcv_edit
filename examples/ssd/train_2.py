...
from torchcv.datasets import listdataset_2
...
parser.add_argument('--model', default='../../../torchcv_edit_rel/model/fpnssd512_20_trained.pth', type=str, help='initialized model path')
parser.add_argument('--checkpoint', default='../../../torchcv_edit_rel/checkpoint/ckpt.pth', type=str, help='checkpoint path')
...
trainset = listdataset_2.ListDataset(img_path_super='../../../Datasets/vanno_data/celeb',
...
testset = listdataset_2.ListDataset(img_path_super='../../../Datasets/vanno_data/celeb',
                                    anno_path_super='../../../Datasets/vanno_results/celeb',
